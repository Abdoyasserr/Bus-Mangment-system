...
namespace Bus_Sytem
{
    public partial class MCLIENTDATA : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'online_BusDataSet48.client' table. You can move, or remove it, as needed.
            this.clientTableAdapter.Fill(this.online_BusDataSet48.client);
