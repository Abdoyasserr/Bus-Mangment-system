...
namespace Bus_Sytem
{
    public partial class MEMPLOYEEDATA : Form
    {
        public MEMPLOYEEDATA()
        {
            InitializeComponent();
        }
        ...
        private void MEMPLOYEEDATA_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'online_BusDataSet52.employee' table. You can move, or remove it, as needed.
            this.employeeTableAdapter.Fill(this.online_BusDataSet52.employee);
