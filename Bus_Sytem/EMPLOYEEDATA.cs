...
namespace Bus_Sytem
{
    public partial class EMPLOYEEDATA : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'online_BusDataSet50.employee' table. You can move, or remove it, as needed.
            this.employeeTableAdapter.Fill(this.online_BusDataSet50.employee);
            // TODO: This line of code loads data into the 'online_BusDataSet47.employee' table. You can move, or remove it, as needed.
            this.employeeTableAdapter6.Fill(this.online_BusDataSet47.employee);
